...
keys = [
    ...
    # 'dmenu_height' package from aur needed for 'dmenu_height' a
    Key(
        [mod],
        "d",
    ...
    Key(
        [mod, "shift"],
        "a",
        lazy.spawn("nvim /home/dimitri/.config/qtile/config.py"),
        desc="Config qtile",
    ...
    Key(
        [mod, "shift"],
        "s",
        lazy.spawn("sharenix-section"),
        desc="Launches sharenix",
    ),
    Key(
        [],
        "XF86AudioMute",
